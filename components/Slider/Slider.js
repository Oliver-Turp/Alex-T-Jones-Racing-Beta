  ...
  return (
    <div className={`${styles["testimonial_wrap"]}`}>
      <section
        ...
        className={styles["testimonial_wrap_grid"]}
      >
        <section
        ...
        {testimonialData.map((el, i) => {
          return (
            ...
            >
              <h3 className={styles.para}>{el.content}</h3>
              <p className={styles.subText}>{el.author}</p>
            </section>
          );
        })}
        <div
      ...
      <section ref={refButtonsParentDiv}>
